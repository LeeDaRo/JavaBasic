...
public class Ex03ArrayList {
    public static void main(String[] args) {
        ...
        // 어떤 클래스 객체의 모음인지 적어주어야 하기 때문에
        // 다음과 같은 방법으로 선언과 초기화를 한다.
        // ArrayList<클래스 이름> 객체이름 = new ArrayList<>();
        // 이러한 <>를 우리가 템플릿이라고 부른다.

        // "Integer" 클래스를 모아둔 ArrayList 객체 list
        ArrayList<Integer> list = new ArrayList<>();

        // 1. 해당 어레이리스트에 객체가 존재하는지 안하는지 체크하고 싶다면?
        System.out.println("isEmpty : " + list.isEmpty());

        // 2. 해당 어레이리스트에 몇개의 객체가 존재하는지 알고싶다면?
        ...
        // 5. 리스트에 특정 위치에 새로운 객체를 끼워 넣을 때에는?
        list.add(1,200);
        System.out.println("get(1) : " + list.get(1));
        ...
        // 특정 요소가 리스트에 존재하는지 알고 싶을 때에는?
        // contains
        System.out.println("list.contains(i1) : " + list.contains(i1));
        System.out.println("list.contains(i4) : " + list.contains(i4));
