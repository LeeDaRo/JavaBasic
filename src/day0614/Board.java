package day0614;
// 게시판 프로그램
// 게시글에는 글 번호, 글 제목, 글 내용, 극 작성자 정보가 들어가야 한다.
    ...
    public static void printBoard(){
        if (ArrayUtil.isEmpty(idArray)){
            ...
            for (int i = 0; i < ArrayUtil.size(idArray); i++){
                System.out.println("===========================================");
                System.out.println("글 제목 : " + ArrayUtil.get(idArray, i));
                System.out.println("글 번호 : " + ArrayUtil.get(titleArray, i));
